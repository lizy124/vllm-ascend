...
class TestCacheLayoutHelpers(unittest.TestCase):
    ...
    def test_infer_group_block_sizes(self):
        ...
        self.assertEqual(infer_group_block_sizes(8, groups, use_hybrid=False), [8])
        self.assertEqual(infer_group_block_sizes(8, None, use_hybrid=True), [8])
    ...
    def test_get_effective_group_block_size(self):
        self.assertEqual(get_effective_group_block_size([16, 32], ["c1", "c2"], 1), 64)

    def test_get_effective_group_block_size_out_of_range(self):
        with self.assertRaises(IndexError):
            get_effective_group_block_size([16, 32], ["c1", "c2"], 5)
